...
module.exports = function(grunt) {
  ...
  grunt.registerMultiTask('gh-pages', 'Publish to src.', function() {
    ...
    getRepo(options)
        ...
        .then(function() {
          if (options.push) {
            log('Pushing');
            log('remote : ' + options.remote);
            log('branch : ' + options.branch);
            log('clone : ' + options.clone);
            return git.push(options.remote, options.branch,
                options.clone);
          } else {
            log('Problem with pushing A.');
            return Q.resolve();
          }
        })
        .then(function() {
